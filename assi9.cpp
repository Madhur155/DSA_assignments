// Write a C++ program to store the monthly salary of an employee in an array. Sort array of numbers in
// ascending order using Merge sort and Display details of top five employees with the highest salary.
